...
//    var flattedGrid = changedGrid.flatMap { $0 }
//    let sortedGrid = flattedGrid.sorted()
//
//    let middleIndex = Int(floor(Double(sortedGrid.count) / 2))
//
//    if sortedGrid[0] >= 0 {
//        return 0
//    } else {
//        if sortedGrid[middleIndex] < 0 {
//            if sortedGrid[middleIndex + 1] >= 0 {
//                return middleIndex + 1
//            }
//            let grid = Array(sortedGrid[middleIndex + 1..<sortedGrid.count])
//            return countNegatives([grid])
//        } else {
//            let grid = Array(sortedGrid[0..<middleIndex])
//            return countNegatives([grid])
//        }
//    }
//}
